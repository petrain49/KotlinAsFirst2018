...
fun mergePhoneBooks(mapA: Map<String, String>, mapB: Map<String, String>): Map<String, String> {
    val ans = mapA.toMutableMap() //mutableMapOf<String, String>()

    for ((key, value) in mapB) {
        if (key in ans && ans[key] != value) ans[key] = ans[key] + ", " + mapB[key]
        else ans[key] = value
    }
    return ans
}
...
fun propagateHandshakes(friends: Map<String, Set<String>>): Map<String, Set<String>> {
    ...
    for (a in friends) for (b in a.value) if (b !in friends.keys) list.add(b)
 ...
 */
fun subtractOf(a: MutableMap<String, String>, b: Map<String, String>): Boolean =
        a.keys.removeAll {a[it] == b[it]}
...
fun hasAnagrams(words: List<String>): Boolean {
    val wordsNew = words.toMutableList().map {it.toLowerCase().split("").sorted()}
    return (wordsNew.toSet().size < words.size)
}
